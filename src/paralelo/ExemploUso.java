...
t1.start(); System.out.println("Executando T1");
t2.start(); System.out.println("Executando T2");
t3.start(); System.out.println("Executando T3");
...
long tempoFinal = System.currentTimeMillis(); // Captura o tempo apos a execucao
